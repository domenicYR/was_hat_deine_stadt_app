...
class ShowSehenswuerdigkeitenScreen extends StatefulWidget {
  List<Map> result;
  int index;
  ...
  @override
  _ShowSehenswuerdigkeitenScreenState createState() => _ShowSehenswuerdigkeitenScreenState();
}
...
class _ShowSehenswuerdigkeitenScreenState extends State<ShowSehenswuerdigkeitenScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: DataModel.cdb.getSehenswuerdigkeiten(widget.result[widget.index]["id"]),
