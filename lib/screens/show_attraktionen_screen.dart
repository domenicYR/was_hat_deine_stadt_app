...
class ShowAttraktionenScreen extends StatefulWidget {
  List<Map> result;
  int index;
  ...
  @override
  _ShowAttraktionenScreenState createState() => _ShowAttraktionenScreenState();
}

class _ShowAttraktionenScreenState extends State<ShowAttraktionenScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: DataModel.cdb.getAttraktionen(widget.result[widget.index]["id"]),
