...
class AddEinkaufslaedenScreen extends StatelessWidget {

  // Konstruktor
  AddEinkaufslaedenScreen(List<Map> result, int index) {
    resultGlobal = result;
    indexGlobal = index;
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      _handleSubmitButton();
                      DataModel.cdb.addEinkaufslaeden(objektDatenFormular.name, objektDatenFormular.beschreibung, objektDatenFormular.link, objektDatenFormular.bild, resultGlobal[indexGlobal]["id"]);
                      _showAlertDialog();
                    },
                    style: ButtonStyle(
